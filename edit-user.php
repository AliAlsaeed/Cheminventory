					...
					<form method="post" action="" name="edit-user" data-id="<?php echo $userd->id; ?>">
						...
						<div class="select-holder">
							...
							<select name="euser-role">
								...
								<option value="2"<?php if($userd->role == 2) echo ' selected'; ?>>Department Administrator</option>
								<option value="3"<?php if($userd->role == 3) echo ' selected'; ?>>Researcher</option>
								<option value="4"<?php if($userd->role == 4) echo ' selected'; ?>>Student</option>
							</select>
						</div>
