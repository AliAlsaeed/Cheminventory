<?php
$_titles = array('','Home','New Chemical','Chemicals','Check-In Chemical','Check-Out Chemical','Logs','Categories','New Category','Users','New User','Edit user','Settings','Edit Chemical','Edit Category','Category Details','Chemical Details','User Details');
$_title = $_titles[$_page];
?>
	<meta charset="utf-8" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=no" />
	<title>TRU Chemical Database - <?php echo $_title; ?></title>
	
<?php if($_page == 1) { ?>
	<link type="text/css" rel="stylesheet" href="media/css/home.css" media="all" />
	<link type="text/css" rel="stylesheet" href="media/css/style.css" media="all" />
