...
class Items {
	...
	public function new_item($name, $descrp, $cat, $qty, $molecularformula,$cas,$supplier,$datereceived,$expierydate,$tarewight,$location,$locationdetail,$chemicalstate,$hazard,$owner,$safety) {
        ...
        try{
		$prepared = $this->prepare("INSERT INTO invento_items(name,molecularformula,cas,supplier,datereceived,expierydate,tarewight,qty,hazard,location,locationdetail,chemicalstate,descrp,category,date_added,owner,safety) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", 'new_item()');
            $temp = $prepared->bind_param('sssssssssssssssss',$name, $molecularformula, $cas, $supplier, $datereceived, $expierydate, $tarewight, $qty, $hazard, $location, $locationdetail,   $chemicalstate, $descrp, $cat, $date,$owner,$safety);
	...
	public function update_item($itemid, $name, $descrp, $cat, $price) {
		// Create log
		...
		$this->bind_param($prepared->bind_param('ssssi', $name, $descrp, $cat, $price, $itemid), 'update_item()');
