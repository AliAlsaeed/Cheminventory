...
<body>
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			<h2 class="noborder">Check-Out Chemical</h2>
			<span class="downtitle">Click a Chemical to check-out</span>
			<div id="table-head">
    ...
    border: none;
    border-radius: 4px;
    cursor: pointer;" type="button" value="Reset" onclick="window.location.href='http://www.cheminventory.ca/check-out.php'" />
				</form>
